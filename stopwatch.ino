...
int Common = 0;   //<Common=0; for Common cathode> <Common=1; for Common anode>
...
if(digitalRead (bt_up) == 1 && timer==0){ timer = 20;
digitalWrite(buzzer, HIGH);
if(Set==0){Mode = !Mode;
if(hh>0 || mm>0){
...
if(digitalRead (bt_down) == 1 && timer==0){ timer = 20;
digitalWrite(buzzer, HIGH);
